...
output_file="timing_results_no_omp.txt"
...
do
	...
	command="mpiexec --use-hwthread-cpus --oversubscribe --bind-to hwthread --map-by ppr:1:hwthread -np $i ./Run6-5 $xl $yl $xr $yr $width $height $max_iterations"
